...
let items = [{id:1, name: 'Milk'},{id:2, name: 'Yogurt'},{id:3, name: 'Orange Juice'}];
  ...
  render() {
    ...
    return(
      <div>
        ...
        transitionName="example" transitionEnterTimeout={300} transitionLeaveTimeout={300} transitionAppear={true} transitionAppearTimeout={300}>
          {shoppingItems}
        </ReactCSSTransitionGroup>
